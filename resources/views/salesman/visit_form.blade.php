    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 text-uppercase">Log Store Visit</h4>
                    ...
                    <div class="card-body p-4">
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <select name="vendor_id" class="form-select border-primary-subtle bg-light-subtle">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="purpose" class="form-select border-primary-subtle bg-light-subtle">
                        ...
                        <div class="col-12">
                            <div class="bg-light p-4 rounded shadow-sm border">
                                <label class="form-label fw-bold d-block mb-3 text-uppercase fs-11 tracking-wider text-muted">Session Outcome</label>
